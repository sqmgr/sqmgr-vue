        ...
        <div class="content-grid">
            ...
            <div class="card tip-card">
                <div class="card-body">
                    ...
                    <p>SqMGR is a labor of love maintained by a single developer. If you enjoy using the site, please consider chipping in to help cover server costs and keep this service 100% free.</p>
                </div>
